...
namespace PJobs
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<KiNangRepository, KiNangRepository>();
            services.AddTransient<UngVienKiNangRepository, UngVienKiNangRepository>();
            services.AddTransient<UngVienDangKiRepository, UngVienDangKiRepository>();
